  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="relative overflow-hidden px-6 pt-20 pb-16">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight mb-6">
            ...
            <span className="text-gray-500"> Find out.</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-14">
            ...
            {!user && (
              <button
                ...
                className="border border-gray-700 text-gray-200 font-bold px-8 py-3.5 rounded-xl text-lg hover:border-gray-500 hover:text-white transition hover:-translate-y-0.5"
              >
                Create Account
              </button>
            )}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-900/90 border border-gray-800 rounded-3xl overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
              ...
              <div className="px-6 md:px-10 pt-8 pb-10 text-left text-xl md:text-2xl font-mono tracking-wide leading-relaxed">
                ...
                <span className="text-white border-l-2 border-yellow-400 animate-pulse pl-[2px]">
                  d
                </span>
      ...
      <section className="px-6 pb-10">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 overflow-hidden rounded-2xl border border-gray-800 bg-gray-900">
          <div className="px-6 py-7 text-center border-b md:border-b-0 md:border-r border-gray-800">
            <div className="text-3xl font-mono font-bold text-yellow-400">12k+</div>
            <div className="text-xs uppercase tracking-widest text-gray-500 mt-2">
              Tests Taken
            </div>
          </div>
          <div className="px-6 py-7 text-center border-b md:border-b-0 md:border-r border-gray-800">
            <div className="text-3xl font-mono font-bold text-yellow-400">148</div>
            <div className="text-xs uppercase tracking-widest text-gray-500 mt-2">
              Top WPM
            </div>
          </div>
          <div className="px-6 py-7 text-center md:border-r border-gray-800">
            <div className="text-3xl font-mono font-bold text-yellow-400">3.2k</div>
            <div className="text-xs uppercase tracking-widest text-gray-500 mt-2">
              Users
            </div>
          </div>
          <div className="px-6 py-7 text-center">
            <div className="text-3xl font-mono font-bold text-yellow-400">98%</div>
            <div className="text-xs uppercase tracking-widest text-gray-500 mt-2">
              Avg Accuracy
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 text-center hover:border-gray-700 hover:-translate-y-1 transition">
            ...
            <h3 className="text-lg font-bold mb-3">Real-time WPM</h3>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 text-center hover:border-gray-700 hover:-translate-y-1 transition">
            ...
            <h3 className="text-lg font-bold mb-3">Progress Dashboard</h3>
            <p className="text-gray-500 text-sm leading-6">
      ...
      <section className="px-6 pt-4 pb-20">
        <div className="max-w-4xl mx-auto rounded-3xl border border-yellow-400/20 bg-gradient-to-br from-yellow-400/10 to-gray-900 p-10 md:p-14 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button
              ...
              className="border border-gray-700 text-gray-200 font-bold px-8 py-3 rounded-xl hover:border-gray-500 hover:text-white transition"
            >
              View Leaderboard
            </button>
          </div>
      ...
      <footer className="border-t border-gray-900 px-6 py-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          ...
          <div className="flex items-center gap-5">
            <a href="https://github.com/kuldeeptiwari91/Keystrike" className="hover:text-yellow-400 transition">
              GitHub
            </a>
            <a href="https://keystrike-typing.vercel.app" className="hover:text-yellow-400 transition">
              Live Demo
            </a>
          </div>
        </div>
